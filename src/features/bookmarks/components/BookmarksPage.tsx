...
import { Plus, Trash2, GripVertical, ExternalLink, Search, X, Globe } from 'lucide-react';
...
export const useBookmarkStore = create<BookmarkStore>()(
  persist(
    (set) => ({
      ...
      addBookmark: (b) =>
        set((state) => ({
          bookmarks: [...state.bookmarks, { ...b, id: generateId(), order: state.bookmarks.length, addedAt: new Date().toISOString() }],
        })),
      deleteBookmark: (id) =>
